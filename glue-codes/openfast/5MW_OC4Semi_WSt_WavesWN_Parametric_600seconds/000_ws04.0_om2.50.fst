...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_OC4DeepCwindSemi_ElastoDyn_000_ws04.0_om2.50.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"../5MW_Baseline/NRELOffshrBsline5MW_InflowWind_Steady8mps_000_ws04.0_om2.50.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
...
"NRELOffshrBsline5MW_OC4DeepCwindSemi_HydroDyn_000_ws04.0_om2.50.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
